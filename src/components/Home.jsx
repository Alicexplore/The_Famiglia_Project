                 ...
                 bg-black/10 flex flex-col items-center justify-center place-items-center'>
                    ...
                    <h1 className='px-4 mb-18 mt-1 text-sm sm:text-sm md:text-base lg:text-xl font-worksans font-light tracking-widest'>WE MAKE VEGAN FOOD NOT WAR</h1>
                        <div className='grid grid-cols-2 place-items-center my-16 gap-8'>
                            ...
                            <Link to="/Food"><button className='font-worksans p-2 pl-5 pr-5 bg-[#58731a] border-2 border-[#58731a] text-[#F2F2F2] text-base rounded-sm transition-colors duration-700 transform hover:bg-[#F2F2F2] hover:text-black hover:border-[#F2F2F2]'>TASTE US</button></Link>
                        </div>
